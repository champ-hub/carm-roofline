...
from carm_roofline.benchmark.suites import MemorySweepBenchmarkSuite
from carm_roofline.core import Cycles
from carm_roofline.isa import BaseISA
from carm_roofline.output_utils import error, warn
...
def _print_table(context: CARMContext, isa_suites: dict[str, ISABenchmarkSuite]) -> None:
    ...
    from carm_roofline.output_utils import get_console
...
def _collect_sweep_series(
    ...
    """
    from carm_roofline.benchmark.suites.memory_sweep import (
        MemorySweepBenchmarkSuite,  # local import avoids circular dep
    )
